        ...
        <>
            ...
            <div className='p-2 md:p-4'>
                ...
                {productCartItem[0] ?
                    ...
                    :
                    <>
                    <div className='flex w-full justify-center items-center flex-col rounded-full'>
                        <img src={emptyCart} alt=' ' className='w-full max-w-sm rounded-full' />
                        <p className='text-slate-500 text-3xl font-bold my-4'>Empty Cart :(</p>
                    </div>
                    </>
                }
            </div>
